...
CREATE TABLE IF NOT EXISTS tournament_challenge (
...
CREATE INDEX IF NOT EXISTS idx_challenge_tournament_status ON tournament_challenge(tournament_id, status);
CREATE INDEX IF NOT EXISTS idx_challenge_challenger ON tournament_challenge(challenger_id);
CREATE INDEX IF NOT EXISTS idx_challenge_opponent ON tournament_challenge(opponent_id);
